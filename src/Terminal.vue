<template>
  <div class="t-container" :style="_draggable() ? _getDragStyle() : 'width:100%;height:100%;border-radius:0;'"
          ...
          <div class="t-header">
            ...
            <ul class="t-shell-dots">
              <li class="shell-dot-item t-shell-dots-red">
                <svg t="1645078279626" class="t-shell-dot" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="1864" width="10" height="10" @click="_triggerClick('close')">
                  <path
              ...
              <li class="shell-dot-item t-shell-dots-yellow">
                <svg t="1645078503601" class="t-shell-dot" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="2762" width="10" height="10"
                  @click="_triggerClick('minScreen')">
                  <path d="M872 474H152c-4.4 0-8 3.6-8 8v60c0 4.4 3.6 8 8 8h720c4.4 0 8-3.6 8-8v-60c0-4.4-3.6-8-8-8z"
                    p-id="2763" fill="#1413139c"></path>
                </svg>
              </li>
              <li class="shell-dot-item t-shell-dots-green">
                <svg t="1645078604258" class="t-shell-dot" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="9907" width="10" height="10"
                  @click="_triggerClick('fullScreen')">
                  <path
      ...
      <div class="t-window" :style="`${showHeader ? 'height:calc(100% - 34px);margin-top: 34px;' : 'height:100%'}`"
        ...
        <div v-if="ask.open && ask.question" style="display: flex">
          ...
          <input :type="ask.isPassword ? 'password' : 'text'" ref="askInput" v-model="ask.input" class="t-ask-input"
            autocomplete="off" auto-complete="new-password" @keyup.enter="_onAskInput">
        </div>
        <p class="t-last-line t-crude-font t-cmd-line" ref="terminalInputBox" v-show="showInputLine">
          ...
          <input type="text" autofocus="autofocus" v-model="command" class="t-cmd-input disable-select" ref="cmdInput"
            autocomplete="off" auto-complete="new-password" @keydown="_onInputKeydown" @keyup="_onInputKeyup"
            @input="_onInput" @focusin="cursorConf.show = true" @focusout="cursorConf.show = false"
            @keyup.up.exact="_switchPreCmd" @keyup.down.exact="_switchNextCmd" @keyup.enter="_execute">
