<template>
  <div class="t-header">
    <h4>
      <span @click="$parent._triggerClick('title')" class="t-disable-select" style="cursor: pointer;">{{ title }}</span>
    </h4>
    <ul class="t-shell-dots">
      <li class="shell-dot-item t-shell-dots-red" @click="$parent._triggerClick('close')" title="关闭">
        <svg t="1645078279626"
             class="t-shell-dot"
      ...
      <li class="shell-dot-item t-shell-dots-yellow" @click="$parent._triggerClick('minScreen')" title="最小化">
        <svg t="1645078503601"
             class="t-shell-dot"
             viewBox="0 0 1024 1024"
             version="1.1"
      ...
      <li class="shell-dot-item t-shell-dots-green" @click="$parent._triggerClick('fullScreen')" title="最大化">
        <svg t="1645078604258"
             class="t-shell-dot"
             viewBox="0 0 1024 1024"
             version="1.1"
...
<script>
import {terminalHeaderProps} from "@/js/TerminalAttribute";
